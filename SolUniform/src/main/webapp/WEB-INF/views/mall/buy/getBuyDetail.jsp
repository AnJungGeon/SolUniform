...
.buyList0 .b1 div:nth-child(3){background: #196ab3; color: #fff; border: 2px solid #19b37c; font-size: 17px; font-weight: 700;}
...
.buyList_table1  .right{text-align: right; padding-right: 30px;}
		...
		<article class="buyList0">
			...
			<article class="buyList1">
				<div class="d_tit">
					...
					<span class="s_tit">주문번호(${buy_id}) 상세 목록</span>
				</div>
				<table class="buyList_table1">
					...
					<tr>
						...
						<td class="right"><fmt:formatNumber value="${buy.buy_price}" pattern="#,###"/>원</td>
